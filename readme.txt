...
This plugin makes it simple to add a temporary splash page to your site. Works
similar to a maintenance mode plugin but allows the site to still be accessible
to regular visitors/users.
